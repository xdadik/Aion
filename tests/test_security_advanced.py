...
class TestSecretRedactor(TestCase):
    ...
    @unittest.skipIf(False, "Module check")  # never force-skip; module check is internal  # Always run if available
    ...
    @unittest.skipIf(False, "Module check")  # never force-skip; module check is internal
